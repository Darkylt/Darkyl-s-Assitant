...
async def report_command(ctx: lightbulb.SlashCommand):
    ...
    try:
        ...
        message = await plugin.bot.application.app.rest.create_message(channel=config.Bot.report_channel, embed=report_embed, components=view)
        ...
        database_interaction.update_user_entry(user_id, increment=True, been_reported=1)
