...
async def warn_command(ctx: lightbulb.SlashContext, user: hikari.OptionType.USER, reason: str):
    """
    ...
    try:
        ...
        if 2 < warnings_count < 4:
            await plugin.bot.rest.kick_user(ctx.guild_id, user_id, reason="Too many warnings.")
            ...
            await plugin.bot.rest.ban_user(ctx.guild_id, user_id, reason="Too many warnings.")
