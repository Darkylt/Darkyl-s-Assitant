...
async def stats_command(ctx: lightbulb.SlashContext):
    ...
    lines, file_count = await utils.count_lines_in_files(directory=config.Paths.root_folder, file_extensions=[".txt", ".py", "", ".yml", ".log", ".json", ".pxd", ".pxi", ".pyi", ".hash", ".pem", ".js", ".html", ".css"])
