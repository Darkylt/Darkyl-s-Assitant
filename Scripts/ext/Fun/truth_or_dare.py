...
@lightbulb.command("truth_or_dare", "Get a truth or dare question.", aliases=["trd"], pass_options=True)
@lightbulb.implements(lightbulb.commands.SlashCommand)
async def truth_or_dare_command(ctx: lightbulb.context.SlashContext, type, category, language) -> None:
    if category == "nsfw":
        nsfw = True
        rating = "r"
    else:
